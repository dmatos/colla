...
/**
 * The class <code>ServerStarterTest</code> contains tests for the class <code>{@link ServerStarter}</code>.
 *
 * @generatedBy CodePro at 10/09/13 19:28
 * @author joaovq
...
public class ServerStarterTest {
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(ServerStarterTest.class);
	}
}