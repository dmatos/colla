...
/**
 * ChatWindow extends JFrame and contains a JTabbedPane were messages can be
 * displayed in a tab which the tittle is the name of the sender of the message.
...
public class ChatWindow extends javax.swing.JInternalFrame {
    ...
    public ChatWindow() {
        ...
        try {
            ...
            userName = devViewer.getUser().getName();
    ...
    /**
     * show the message received in a tab with the sender nickname as tittle
     *
    ...
    /**
     * try to estabilish connection with a contact if it has a valid IP,
     * otherwise try to estabilish connection with the server to transmit the
     * message
     *
    ...
    public void sendMessage(String contactName, String message) {
        try {
            DeveloperViewerController devViewer = DeveloperViewerController.getInstance();
            if (devViewer.sendChatMessage(contactName, message, this.contactsMap.get(contactName))) {
