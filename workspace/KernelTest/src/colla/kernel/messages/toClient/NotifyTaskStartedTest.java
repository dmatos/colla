...
/**
 * The class <code>NotifyTaskStartedTest</code> contains tests for the class <code>{@link NotifyTaskStarted}</code>.
 *
 * @generatedBy CodePro at 10/09/13 18:25
 * @author joaovq
 * @version $Revision: 1.0 $
 */
public class NotifyTaskStartedTest {
	/**
	 * Run the NotifyTaskStarted(CollATask) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 10/09/13 18:25
	 */
	@Test
	public void testNotifyTaskStarted_1()
		throws Exception {
		CollATask task = new Task();

		NotifyTaskStarted result = new NotifyTaskStarted(task);
	...
	public void testGetGroupName_1()
		throws Exception {
		NotifyTaskStarted fixture = new NotifyTaskStarted(new Task());
	...
	public void testGetOperation_1()
		...
		// add additional test code here
		assertNotNull(result);
		assertEquals("TASK_START_NOTIFICATION", result.name());
		assertEquals("TASK_START_NOTIFICATION", result.toString());
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(NotifyTaskStartedTest.class);
	}
}